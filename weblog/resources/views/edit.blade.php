...
<div class="col-md-8 col-sm-12 bg-white p-4">
    <form method="post" action="/edit_process">
        ...
        <div class="form-group">
            <label>Author</label>
            <input type="text" class="form-control" value="{{ $article->author }}" name="author" placeholder="Author">
        </div>
        <div class="form-group">
            <label>Tanggal Update</label>
            <input type="date" class="form-control" value="{{ $article->updated_at }}" name="updated_at" placeholder="Tanggal Update">
        </div>
        <div class="form-group">
